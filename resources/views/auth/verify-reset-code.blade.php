    ...
    <div class="flex-1 flex flex-col lg:flex-row min-h-screen">
        ...
        <div class="lg:w-1/2 flex flex-col justify-between p-8 sm:p-12 lg:p-16 bg-gradient-to-br from-emerald-800 via-teal-900 to-slate-950 text-white relative overflow-hidden border-b lg:border-b-0 lg:border-r border-slate-200 dark:border-slate-800/80">
            ...
            <div class="flex items-center justify-between relative z-10">
                <a href="{{ route('password.request') }}" class="inline-flex items-center gap-2 text-xs font-semibold text-emerald-300 hover:text-slate-900 dark:text-white transition">
            ...
            <div class="my-auto text-center py-12 relative z-10">
                ...
                <p class="mt-3 text-sm sm:text-base text-emerald-100 max-w-md mx-auto font-normal leading-relaxed">
                    Check your email inbox for the 6-digit authentication code sent to <strong class="text-slate-900 dark:text-white font-semibold">{{ $email }}</strong>.
                </p>
            ...
            <div class="grid grid-cols-3 gap-4 pt-6 text-center relative z-10 border-t border-emerald-500/20">
                <div class="flex flex-col items-center">
                    ...
                    <span class="text-xs font-semibold text-slate-900 dark:text-white">15 Minutes</span>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <span class="text-xs font-semibold text-slate-900 dark:text-white">Cryptographic</span>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <span class="text-xs font-semibold text-slate-900 dark:text-white">One-Time Use</span>
        ...
        <div class="lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100">
            <div class="w-full max-w-md bg-white dark:bg-slate-900/90 rounded-3xl shadow-2xl  p-8 sm:p-10 border border-slate-200 dark:border-slate-800 backdrop-blur-sm">
                <div>
                    <h2 class="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Enter Verification Code</h2>
                    <p class="mt-1.5 text-xs sm:text-sm text-slate-500 dark:text-slate-400">Type the 6-digit numeric code sent to your email.</p>
                </div>
                ...
                <form action="{{ route('password.verify.code') }}" method="POST" class="mt-6 space-y-6">
                    ...
                    <div>
                        <label for="code" class="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-2 text-center">6-Digit Code</label>
                        <div class="flex justify-center">
                            <input 
                                ...
                                autofocus 
                                placeholder="------" 
                                class="w-64 tracking-[1em] text-center font-mono text-2xl font-bold bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 border border-slate-300 dark:border-slate-700 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/30 text-emerald-400 rounded-2xl py-3 px-4 transition placeholder-slate-600 outline-none"
                            />
                        </div>
                ...
                <div class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs">
