    ...
    <div class="flex-1 flex flex-col lg:flex-row min-h-screen">
        ...
        <div class="lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16 bg-slate-950">
            <div class="w-full max-w-md bg-slate-900/90 rounded-3xl shadow-2xl shadow-emerald-950/30 p-8 sm:p-10 border border-slate-800 backdrop-blur-sm">
                ...
                <div class="mt-6">
                    <a href="{{ route('auth.google') }}" class="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-slate-700 bg-slate-950 hover:bg-slate-900 hover:border-slate-600 text-white font-medium text-xs transition duration-150 shadow-sm group">
                        ...
                        <span class="group-hover:text-emerald-300 transition">Continue with Google</span>
                    </a>

                    <div class="relative my-6">
                        <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-slate-800"></div></div>
                        <div class="relative flex justify-center text-[11px] uppercase font-mono"><span class="bg-slate-900 px-3 text-slate-500">Or sign in with email</span></div>
                    </div>
                </div>
                <!-- Form -->
