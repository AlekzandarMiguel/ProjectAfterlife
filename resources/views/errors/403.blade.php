...
<div class="flex min-h-[calc(100vh-12rem)] items-center justify-center text-center p-4">
    <div class="space-y-4 max-w-md">
        ...
        <h1 class="text-xl font-bold text-slate-900 dark:text-white">Access Forbidden</h1>
        <p class="text-xs text-slate-500 dark:text-slate-400">You do not have the required permissions or system role to access this resource.</p>
        <div class="pt-2">
